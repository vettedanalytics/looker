view: segment_vetted_tracks_flow {
  derived_table: {
    sql: select a.event_id
      ...
      , d.event as event_4
      , e.event as event_5
from ${segment_vetted_track_facts.SQL_TABLE_NAME} a
left join ${segment_vetted_track_facts.SQL_TABLE_NAME} b
on a.track_sequence_number + 1 = b.track_sequence_number
and a.session_id = b.session_id
left join ${segment_vetted_track_facts.SQL_TABLE_NAME} c
on a.track_sequence_number + 2 = c.track_sequence_number
and a.session_id = c.session_id
left join ${segment_vetted_track_facts.SQL_TABLE_NAME} d
on a.track_sequence_number + 3 = d.track_sequence_number
and a.session_id = d.session_id
left join ${segment_vetted_track_facts.SQL_TABLE_NAME} e
